...
for  str(ip_add.split('.')[0]).isdigit and str(ip_add.split('.')[1]).isdigit and str(ip_add.split('.')[2]).isdigit  and str(ip_add.split('.')[3]).isdigit:
# and str(ip_add.split('.')[0]) in range(256) and str(ip_add.split('.')[1]) in range(256)  and str(ip_add.split('.')[2]) in range(256)  and str(ip_add.split('.')[3]) in range(256):
         print("IP_address is wrong2"):
# and len(ip_add.split('.')) == 4: 
